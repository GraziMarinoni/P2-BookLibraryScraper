...
headings = ["category", "book_title", "product_page_url", "universal_product_code (upc)", "price_incl_tax", "price_excl_tax", "qnt_available", "product_description", "review_rating", "image_url"]
...
def details(url):
    ...
    header_values = [category, book_title, product_page_url, UPC, price_incl_tax, price_excl_tax, qnt_available, product_description, review_rating, image_url]
...
def find_all_categories_links(formatted_html):
    categories = formatted_html.find("div", class_="side_categories")
